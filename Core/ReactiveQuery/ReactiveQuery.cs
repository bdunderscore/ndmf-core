...
namespace nadena.dev.ndmf.ReactiveQuery
{
    ...
    public abstract class ReactiveQuery<T> : IObservable<T>
    {
        ...
        private class SimpleQuery<T> : ReactiveQuery<T>
        {
            private string _description;
            private Func<ComputeContext, Task<T>> _compute;

            public SimpleQuery(string description, Func<ComputeContext, Task<T>> compute)
            {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static ReactiveQuery<T> Create<T>(string description, Func<ComputeContext, Task<T>> compute)
        {
            return new SimpleQuery<T>(description, compute);
        }
